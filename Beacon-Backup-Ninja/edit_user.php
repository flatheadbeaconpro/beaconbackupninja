...
?>
		...
		<form action="edit_user.php?id=<?php echo $user_information['user_id']; ?>" method="post">
			<table class="edit-table">
				...
				<tr>
					<td>Username</td>
					<td><input type="text" name="user_name" value="<?php echo $user_information['user_name'] ?>" /></td>
				</tr>
				<tr>
					<td>Password</td>
					<td><input type="text" name="user_password" placeholder="Leave blank if not changed" /></td>
				</tr>
